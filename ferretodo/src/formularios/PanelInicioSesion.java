	...
	public PanelInicioSesion() {
        ...
        addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e){
				...
				if (JOptionPane.showConfirmDialog(salir, "Realmente desea salir de la aplicación?", TEXT_TITULO, JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION) {
					System.exit(0);
				}
			}
		});
								...
								try {
									...
									if ( estado > 0 ) {
										...
										dispose();
											...
											JOptionPane.showMessageDialog(PanelInicioSesion.this,
										            "Hola " + getUsuario() + "¡ Su sesión se encuentra suspendido, contacte con administrador. !",
										            "Ingreso",
										            JOptionPane.INFORMATION_MESSAGE);
											tUsuario.setText("");
											tClave.setText("");
