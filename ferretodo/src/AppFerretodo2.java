...
public class AppFerretodo2 extends JPanel {
	ImageIcon icono;
	Container cp;
	...
	/*
	public AppFerretodo2(String titulo) {
	...
	*/
	...
	private static void createAndShowGUI() {
        ...
        AppFerretodo2 newContentPane = new AppFerretodo2();
	...
	public static void main(String[] args) {
		// AppFerretodo2 marco = new AppFerretodo2("Ferretodo");
		createAndShowGUI();
	}
}
